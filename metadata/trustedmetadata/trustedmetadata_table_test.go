...
// trustedmetadata_table_test.go drives all TrustedMetadata.Update* paths
// through table-driven subtests. It runs alongside trustedmetadata_test.go
// (and reuses the package-level allRoles, modifyRootMetadata,
// modifyTimestamptMetadata, modifySnapshotMetadata, modifyTargetsMetadata,
// and updateAllBesidesTargets helpers from there) until the iterative
// tests are confirmed redundant and removed.
